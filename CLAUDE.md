...
**v0.3 "Pops & Purpose" built — awaiting user milestone review before starting v0.4 "New Horizons".**
...
Waiting on the user's v0.3 milestone review. Next up on approval: **ROADMAP v0.4 "New Horizons"** — chunk expansion (S7: Survey → buy adjacent 8×8 chunk with Stardust, `chunk-arrival` juice), the 36-chunk soft cap + growth-aware island base/outline, secrets/discoveries (S17), and the Tier 7+ catalog that expansion space makes room for. Mind the exit criteria: chunk-arrival at 60 fps under the 10-arrival torture test, 36-chunk scripted soak within draw/tri budgets (TECH §6.5).
