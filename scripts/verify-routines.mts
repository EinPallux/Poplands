...
async function main(): Promise<void> {
  ...
  await sleep(page, 11000); // let them stroll home + tuck in (WALK_TIMEOUT is 8 sim-seconds)
  const nightHidden = await page.evaluate(() => (window as any).__poplands.hiddenCount());
